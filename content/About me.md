...
**Mail :** matthieu.petiteau@univ-grenoble-alpes.fr  
{{< rawhtml >}}
<div style="display: flex; gap: 1rem; margin-top: 1em;">
  <a href="https://github.com/MatthieuPetiteau" target="_blank" style="text-decoration: none;">
    <button style="background-color: #333; color: white; border: none; padding: 8px 8px; border-radius: 16px; display: flex; align-items: center;">
      <i class="fab fa-github" style="margin-right: 0px;"></i>
    </button>
  </a>
  <a href="https://www.linkedin.com/in/matthieu-petiteau-175886196/" target="_blank" style="text-decoration: none;">
    <button style="background-color: #0077b5; color: white; border: none; padding: 8px 8px; border-radius:16px; display: flex; align-items: center;">
      <i class="fab fa-linkedin" style="margin-right: 0px;"></i>
    </button>
  </a>
</div>
{{< /rawhtml >}}
...
## About me
---
I am currently a PhD student at Institut Fourier (Grenoble, France) with [Sylvain Gravier](https://www.researchgate.net/profile/Sylvain-Gravier) and [Isabelle Sivignon](https://isivigno.github.io).

I am deeply interested in combinatorial optimization, graph theory, and algorithms, with a particular curiosity about problems involving notions of parity.

I am also well-versed in teaching and take great pleasure in sharing mathematics and computer science with diverse audiences, including through outreach and popularization activities.
...
- [Journées Graphes et Algorithmes](https://jga2023.sciencesconf.org) *JGA 2023*, (Lyon, France), 21-24 November, 2023
